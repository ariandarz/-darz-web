# Frontend adoption — the V1 API gaps are now closed backend-side

**Written 2026-09-24. Audience: a session working in THIS repo (`-darz-web`).**

Every gap in `../darzmarket-api/docs/V1_API_GAPS_PLAN.md` has shipped on the backend
(`darz-backend-api` `development` @ `5f6d7ea`; see its `docs/CHANGELOG.md`, all entries dated
2026-09-24). This file is the frontend's side of that work: for each closed gap, the endpoint/field
now available, the work-around to delete, and where that work-around lives in this repo.
